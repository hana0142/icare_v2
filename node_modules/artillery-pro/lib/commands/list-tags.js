 ...
 *
 */
module.exports={listTags:listTagsCommand};const{listTags}=require("../data-api/list-tags");async function listTagsCommand(options){try{var tags=await listTags();console.log(JSON.stringify(tags))}catch(err){console.error("Something went wrong"),console.error(err),process.exit(1)}}