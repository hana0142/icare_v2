 ...
 *
 */
module.exports={listTags:listTags};const debug=require("debug")("data-api:list-tags"),Store=require("./store")(process.env.BACKEND_STORE);async function listTags(){return await Store.init(),await Store.listTags()}