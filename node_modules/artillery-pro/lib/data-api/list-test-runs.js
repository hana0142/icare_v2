...
module.exports = { listTestRuns };

const Store = require('./store')(process.env.BACKEND_STORE);

async function listTestRuns(tags = []) {
  await Store.init();
  const results = await Store.listTestRuns(tags);
  return results;
}
