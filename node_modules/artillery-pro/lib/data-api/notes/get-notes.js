 ...
 *
 */
module.exports={getNotes:getNotes};const debug=require("debug")("data-api:notes:get-notes"),Store=require("../store")(process.env.BACKEND_STORE);async function getNotes(testRunId){return await Store.init(),await Store.getNotes(testRunId)}