 ...
 *
 */
module.exports={postNote:postNote};const debug=require("debug")("data-api:notes:create-note"),Store=require("../store")(process.env.BACKEND_STORE);async function postNote(testRunId,text,opts){return await Store.init(),await Store.addNote(testRunId,text,opts)}